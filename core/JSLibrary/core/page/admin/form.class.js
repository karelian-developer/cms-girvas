...
export class PageForm {
  ...
  addElement(localeData, anchorElement, data = {}) {
    ...
    this.appendRows(rowsElement, formElements, typeSelect, requiredCheckbox, actionButtons.removeButton);
  ...
  appendRows(rowsElement, formElements, typeSelect, requiredCheckbox, removeButton) {
