...
export class PageForms {
  ...
  init() {
    this.page.core.locales.admin.getData().then((localeData) => {
      ...
      interactiveCreatePageButton.target.setLabel(localeData.BUTTON_NEW_FORM_LABEL);
      ...
      const tableItems = document.querySelectorAll('[data-element="form"]');
      for (let tableItem of tableItems) {
        const formID = tableItem.getAttribute('data-id');
