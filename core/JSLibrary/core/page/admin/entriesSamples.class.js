...
export class PageEntriesSamples {
          ...
          panelElement.addEventListener('click', (event) => {
            if (panelElement.getAttribute('data-event') === 'remove') {
              ...
              interactiveModal.target.addButton(localeData.BUTTON_DELETE_LABEL, () => {
                ...
                formData.append('entries_sample_id', entriesSampleID);

                let request = new Interactive('request', {
                  method: 'DELETE',
                  url: '/handler/entries/sample/' + entriesSampleID + '?localeMessage=' + window.CMSCore.locales.admin.name
                });
