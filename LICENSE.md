Настоящее лицензионное соглашение (далее – "Соглашение") заключается между __Индивидуальным предпринимателем Шестаковым Андреем Руслановичем__, действующим на основании листа записи ЕГРИП от 08.11.2023 №323100000029062 (далее – "Правообладатель") и любым __физическим лицом__, __индивидуальным предпринимателем__, __юридическим лицом__ (далее – "Пользователь"), использующим Программу.

## 1. ОСНОВНЫЕ ТЕРМИНЫ
1.1. __Программа__ – программа для ЭВМ "Система управления содержимым ГИРВАС" или "CMS GIRVAS", внесенная в Реестр российского программного обеспечения Министерства цифрового развития Российской Федерации от 27.11.2024 под номером 25012 реестровой записи, соответствующей версии (как в целом, так и ее компоненты), являющаяся представленной в объективной форме совокупностью данных и команд, в том числе, исходного текста, базы данных, аудиовизуальных произведений, включенных Правообладателем в состав указанной программы для ЭВМ, а также любая документация по её использованию.

1.2. __Использование программы__ - любые действия, связанные с функционированием Программы в соответствии с ее назначением (в том числе запись в память ЭВМ).

1.3. __Техническая поддержка__ – мероприятия, осуществляемые Правообладателем в установленных им пределах и объемах для обеспечения функционирования Программы, включая информационно-консультационную поддержку Пользователей по вопросам использования Программы.

1.4. __Пользователь__ - физическое или юридическое лицо, или индивидуальный предприниматель, получающий лицензию на право использования Программы по данному лицензионному соглашению.

1.5. __Активационный цифровой ключ (далее - АЦК)__ - специальный цифровой ключ в виде уникального набора символов, который необходим для активации Программы.
