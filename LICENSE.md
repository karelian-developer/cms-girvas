Настоящее лицензионное соглашение (далее – "Соглашение") заключается между Индивидуальным предпринимателем Шестаковым Андреем Руслановичем, действующим на основании листа записи ЕГРИП от 08.11.2023 №323100000029062 (далее – "Правообладатель") и любым физическим лицом, индивидуальным предпринимателем, юридическим лицом (далее – "Пользователь"), использующим Программу.

## 1. ОСНОВНЫЕ ТЕРМИНЫ
1.1. Программа – программа для ЭВМ «Система управления содержимым ГИРВАС» или «CMS «ГИРВАС», внесенная в Реестр российского программного обеспечения Министерства цифрового развития Российской Федерации от 27.11.2024 под номером 25012 реестровой записи, соответствующей версии (как в целом, так и ее компоненты), являющаяся представленной в объективной форме совокупностью данных и команд, в том числе, исходного текста, базы данных, аудиовизуальных произведений, включенных Правообладателем в состав указанной программы для ЭВМ, а также любая документация по её использованию.
...
1.4. Пользователь - физическое или юридическое лицо, или индивидуальный предприниматель, получающий лицензию на право использования Программы по данному лицензионному соглашению.
...
1.6. Технические данные – сведения, автоматически передаваемые Программой Правообладателю при установке и/или использовании Программы, включая: доменное имя, IP-адрес сервера, адрес электронной почты администратора, а также иную техническую информацию, необходимую для мониторинга использования Программы, оказания технической поддержки и информирования Пользователя об обновлениях.

## 2. ПРЕДМЕТ ЛИЦЕНЗИОННОГО СОГЛАШЕНИЯ
2.1. Предметом настоящего лицензионного соглашения является право использования одной или нескольких лицензионных копий Программы, в порядке и на условиях, установленных настоящим соглашением. Если вы не согласны с условиями данного соглашения, вы не можете использовать данный продукт. Установка и использование продукта означает ваше полное согласие со всеми пунктами настоящего соглашения.
...
3.3. В случае получением Пользователем Программы для передачи непосредственным заказчикам уже готового сайта или проекта, Пользователь обязан уведомить заказчика о настоящем лицензионном соглашении, а также полностью передать ему свой клиентский доступ на сайте (https://cms-girvas.ru), в противном случае, Пользователем лицензии остается лицо непосредственно получившее лицензию, и имеющие клиентский доступ на сайте (https://cms-girvas.ru). Третьим лицам, не имеющим данного доступа, в поддержке и предоставлению дистрибутивов будет отказано.

3.4. При установке и/или использовании Программы Пользователь дает согласие на автоматическую передачу Правообладателю Технических данных (доменное имя, IP-адрес сервера, адрес электронной почты администратора) в целях мониторинга использования Программы, оказания Технической поддержки и информирования об обновлениях. Передача указанных данных не является распространением персональных данных в смысле Федерального закона №152-ФЗ "О персональных данных", поскольку осуществляется в целях исполнения настоящего Соглашения и не предполагает передачу данных третьим лицам.

3.5. Мы оставляем за собой право публиковать, с согласия пользователя программного продукта, списки избранных сайтов, на которых используется Программа CMS «ГИРВАС». Мы оставляем за собой право в любое время изменять условия данного договора, но данные изменения не имеют обратной силы. Изменения данного договора будут разосланы пользователям по электронной почте на адреса, указанные при приобретении лицензии на Программу.
...
4.2. Название CMS «ГИРВАС», а также входящие в данную Программу скрипты являются собственностью Правообладателя, использование которых возможно только в рамках данного соглашения, за исключением случаев, когда для компонента системы применяется другой тип лицензии. Любые публикуемые оригинальные материалы, создаваемые в результате использования нашей Программы, и связанные с этим права на них, являются собственностью пользователя и защищены законом. Правообладатель не несет никакой ответственности за содержание сайтов, создаваемых пользователем Программы CMS «ГИРВАС».
...
5.2.4 Использовать копии Программы по одной лицензии на более чем одном сайте (одном домене второго уровня и его поддоменах).

5.2.5 Рекламировать, продавать или публиковать на своем сайте пиратские копии Программы.

5.2.6 Использовать, распространять нелицензионные копии Программы или содействовать распространению нелицензионных копий Программы.
