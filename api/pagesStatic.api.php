...
if ($CMSCore->urlp->getPath(2) === 'additional-fields') {
  ...
  $fieldsCategoriesIDs = $CMSCore->configurator->existsDatabaseEntryValue('static_pages_additional_field_category_id') ? json_decode($CMSCore->configurator->getDatabaseEntryValue('static_pages_additional_field_category_id'), true) : [];
