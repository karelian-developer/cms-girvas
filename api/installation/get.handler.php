...
if (!file_exists(CMS_ROOT_DIRECTORY . '/INSTALLED')) {
  ...
  if ($installationStepIndex === 5) {
    ...
    if (!file_exists($fileCMSConfigurationPath)) {
      ...
      fwrite($file, '    \'default-src \\\'self\\\' *.cms-girvas.ru cms-girvas.ru *.xn--80afbjh2aegfdbd2a2a2a.xn--p1ai xn--80afbjh2aegfdbd2a2a2a.xn--p1ai vk.com vk.ru ok.ru *.ok.ru odnoklassniki.ru *.odnoklassniki.ru okcdn.ru *.okcdn.ru\',' . PHP_EOL);
      fwrite($file, '    \'style-src \\\'unsafe-inline\\\' {DOMAIN} {DOMAIN_ALIASES} *.cms-girvas.ru cms-girvas.ru *.xn--80afbjh2aegfdbd2a2a2a.xn--p1ai xn--80afbjh2aegfdbd2a2a2a.xn--p1ai *.ok.ru ok.ru *.odnoklassniki.ru\',' . PHP_EOL);
      fwrite($file, '    \'script-src \\\'unsafe-inline\\\' \\\'unsafe-eval\\\' {DOMAIN} {DOMAIN_ALIASES} *.cms-girvas.ru cms-girvas.ru *.xn--80afbjh2aegfdbd2a2a2a.xn--p1ai xn--80afbjh2aegfdbd2a2a2a.xn--p1ai *.mail.ru *.ok.ru ok.ru *.odnoklassniki.ru *.okcdn.ru http://*.okcdn.ru https://*.okcdn.ru\',' . PHP_EOL);
      fwrite($file, '    \'script-src-elem \\\'unsafe-inline\\\' \\\'unsafe-eval\\\' {DOMAIN} {DOMAIN_ALIASES} *.cms-girvas.ru cms-girvas.ru *.xn--80afbjh2aegfdbd2a2a2a.xn--p1ai xn--80afbjh2aegfdbd2a2a2a.xn--p1ai *.ok.ru ok.ru *.odnoklassniki.ru *.okcdn.ru\',' . PHP_EOL);
      fwrite($file, '    \'manifest-src \\\'self\\\' *.cms-girvas.ru cms-girvas.ru *.xn--80afbjh2aegfdbd2a2a2a.xn--p1ai xn--80afbjh2aegfdbd2a2a2a.xn--p1ai *.ok.ru\',' . PHP_EOL);
      fwrite($file, '    \'img-src \\\'self\\\' data: *.cms-girvas.ru cms-girvas.ru *.xn--80afbjh2aegfdbd2a2a2a.xn--p1ai xn--80afbjh2aegfdbd2a2a2a.xn--p1ai *.ok.ru ok.ru *.odnoklassniki.ru okcdn.ru *.okcdn.ru\'' . PHP_EOL);
      fwrite($file, '    \'img-src \\\'self\\\' *.cms-girvas.ru cms-girvas.ru *.xn--80afbjh2aegfdbd2a2a2a.xn--p1ai xn--80afbjh2aegfdbd2a2a2a.xn--p1ai ok.ru *.ok.ru odnoklassniki.ru *.odnoklassniki.ru vk.com vk.ru\'' . PHP_EOL);
      fwrite($file, '    \'img-src \\\'self\\\' *.cms-girvas.ru cms-girvas.ru *.xn--80afbjh2aegfdbd2a2a2a.xn--p1ai xn--80afbjh2aegfdbd2a2a2a.xn--p1ai *.ok.ru ok.ru *.odnoklassniki.ru okcdn.ru *.okcdn.ru stats.vk-portal.net\'' . PHP_EOL);
      fwrite($file, '  ],' . PHP_EOL);
