  ...
  <div class="admin-panel__wrapper">
    <nav class="admin-panel__navigation admin-navigation">
      ...
      <ul class="admin-navigation-list list-reset">
        ...
        <li class="admin-navigation-list__item item item_about" role="mainNavigationAbout">
          <a href="/admin/about" class="admin-navigation-list__item-link" title="{LANG:MAIN_NAVIGATION_ABOUT_CMS_LABEL}">
            <svg class="admin-navigation-list__item-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
              ...
              <path d="M27,40.55A9.79,9.79,0,0,1,28.28,35,19.38,19.38,0,0,1,33,30.79a8.47,8.47,0,0,0,2.78-2.74,7,7,0,0,0,1-3.77,5.08,5.08,0,0,0-1.19-3.53,4.31,4.31,0,0,0-3.38-1.32,4.23,4.23,0,0,0-2.95,1.08A4.31,4.31,0,0,0,28,23.73H19.37l-.06-.16c0-3.66,1.12-6.4,3.5-8.24s5.52-2.76,9.42-2.76q6.29,0,9.88,3.17a10.8,10.8,0,0,1,3.6,8.54,10.34,10.34,0,0,1-2,6.07,14.17,14.17,0,0,1-5,4.35,5.93,5.93,0,0,0-2.28,2.38,8.32,8.32,0,0,0-.6,3.47Zm8.89,11H27V44.4h8.86Z"/>
            </svg>
            <div class="admin-navigation-list__item-label">{LANG:MAIN_NAVIGATION_ABOUT_CMS_LABEL}</div>
          </a>
        </li>
