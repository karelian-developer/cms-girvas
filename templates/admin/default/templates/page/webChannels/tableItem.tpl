<tr class="table__row table-web-channels__item" data-web-channel-id="{WEB_CHANNEL_ID}" data-web-channel-name="{WEB_CHANNEL_NAME}">
  <td class="table__cell" style="width: fit-content;">#{WEB_CHANNEL_INDEX}</td>
  <td class="table__cell"><a href="/admin/webChannel/{WEB_CHANNEL_ID}">{WEB_CHANNEL_TITLE}</a></td>
